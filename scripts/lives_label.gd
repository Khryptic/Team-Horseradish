...
func _ready() -> void:
	...
	life_icon_end_tween.y += 70 # for some reason there is an offset between the global position of the respawn point and the global position of the life_icons
